  ...
  <div class="wrapper">
    <header class="main-header">
      ...
      <a href="#" class="logo">
        ...
        <span class="logo-lg" style="text-transform:uppercase;font-weight:bold;overflow:hidden;"><i class="fa fa-bank"></i> <?php echo $building_name; ?>
      </a>
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          <li class="<?php if ($page_name != '' && $page_name == 'e_dashboard') {
                        echo 'active';
                      } ?>"><a href="<?php echo WEB_URL; ?>e_dashboard.php"> <i class="fa fa-line-chart"></i><span><?php echo $_data['menu_dashboard']; ?></span></a> </li>
          <li class="<?php if ($page_name != '' && $page_name == 'rented_details') {
                        echo 'active';
                      } ?>"><a href="<?php echo WEB_URL; ?>e_dashboard/rented_details.php"> <i class="fa fa-users"></i><span><?php echo $_data['rented_details']; ?></span></a></li>
          <!-- <li class="<?php if ($page_name != '' && $page_name == 'member_details') {
                            echo 'active';
                          } ?>"><a href="<?php echo WEB_URL; ?>e_dashboard/member_details.php"> <i class="fa fa-user-o"></i><span><?php echo $_data['member_details']; ?></span></a></li> -->
          <!-- <li class="<?php if ($page_name != '' && $page_name == 'ownerlist') {
                            echo 'active';
                          } ?>"><a href="<?php echo WEB_URL; ?>e_dashboard/ownerlist.php"> <i class="fa fa-user"></i><span><?php echo $_data['owner_details']; ?></span></a></li> -->
          <li class="<?php if ($page_name != '' && $page_name == 'leave_request_list' || $page_name == 'add_leave_request') {
                        echo 'active';
                      } ?>"><a href="<?php echo WEB_URL; ?>e_dashboard/leave_request_list.php"> <i class="fa fa-bell"></i><span><?php echo $_data['leave_request']; ?></span></a></li>
          <li class="<?php if ($page_name != '' && $page_name == 'visitorlist' || $page_name == 'addvisitor') {
                        echo 'active';
                      } ?>"><a href="<?php echo WEB_URL; ?>e_dashboard/visitorlist.php"> <i class="fa fa-car"></i><span><?php echo $_data['e_visitor_list']; ?></span></a></li>
          <li class="<?php if ($page_name != '' && $page_name == 'complain') {
                        echo 'active';
                      } ?>"><a href="<?php echo WEB_URL; ?>e_dashboard/complain.php"> <i class="fa fa-comments"></i><span><?php echo $_data['text_complain_job']; ?></span></a></li>
          <li class="<?php if ($page_name != '' && $page_name == 'salary_details') {
                        echo 'active';
                      } ?>"><a href="<?php echo WEB_URL; ?>e_dashboard/salary_details.php"> <i class="fa fa-money"></i><span><?php echo $_data['salary_statement']; ?></span></a></li>
          <li class="treeview <?php if ($page_name != '' && $page_name == 'e_report' || $page_name == 'v_report') {
                                echo 'active';
                              } ?>"><a href="#"> <i class="fa fa-bar-chart-o"></i><span><?php echo $_data['salary_report']; ?></span> <i class="fa fa-angle-left pull-right"></i> </a>
            <ul class="treeview-menu">
              <li class="<?php if ($page_name != '' && $page_name == 'e_report') {
                            echo 'active';
                          } ?>"><a href="<?php echo WEB_URL; ?>e_dashboard/e_report.php"> <i class="fa fa-angle-double-right"></i><span><?php echo $_data['salary_report_text']; ?></span></a></li>
              <li class="<?php if ($page_name != '' && $page_name == 'v_report') {
                            echo 'active';
                          } ?>"><a href="<?php echo WEB_URL; ?>e_dashboard/v_report.php"> <i class="fa fa-angle-double-right"></i><span><?php echo $_data['visitor_report_text']; ?></span></a></li>
            </ul>
          ...
          <li class="treeview <?php if ($page_name != '' && $page_name == 'utility_list2') {
              ...
              <ul class="treeview-menu">
                <li class="<?php if ($page_name != '' && $page_name == 'utility_list2') {
                              echo 'active';
                            } ?>"><a href="<?php echo WEB_URL; ?>e_dashboard/utility_list2.php"><i class="fa fa-angle-double-right"></i><?php echo "Danh sách tiện ích"; ?></a>
                </li>
            ...
            <li class="treeview <?php if ($page_name != '' && $page_name == 'service_list2' || $page_name == 'sub_list' || $page_name == 'sub_details') {
              ...
              <ul class="treeview-menu">
                <li class="<?php if ($page_name != '' && $page_name == 'service_list2') {
                              echo 'active';
                            } ?>"><a href="<?php echo WEB_URL; ?>e_dashboard/service_list2.php"><i class="fa fa-angle-double-right"></i><?php echo "Danh sách dịch vụ"; ?></a>
                </li>
                <li class="<?php if ($page_name != '' && $page_name == 'sub_list' || $page_name == 'sub_details') {
                              echo 'active';
                            } ?>"><a href="<?php echo WEB_URL; ?>e_dashboard/sub_list.php"><i class="fa fa-angle-double-right"></i><?php echo "Danh sách đăng ký dịch vụ"; ?></a>
                </li>
              </ul>
            </li>
        </ul>
