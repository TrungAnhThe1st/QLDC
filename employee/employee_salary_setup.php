...
if (isset($_POST['ddlEmpName'])) {
  $year_id = getYearId(date('Y', strtotime(str_replace('/', '-', $_POST['txtEmpIssueDate']))));
  $month_id = date('n', strtotime(str_replace('/', '-', $_POST['txtEmpIssueDate'])));

  if ($_POST['hdnSpid'] == '0') {
    $sql = "INSERT INTO `tbl_add_employee_salary_setup`(`emp_name`,`designation`,`month_id`,`xyear`,`amount`,`issue_date`,`branch_id`) 
    VALUES ('$_POST[ddlEmpName]','$_POST[hdnDesg]','$month_id',$year_id,'$_POST[txtEmpAmount]','$_POST[txtEmpIssueDate]','" . $_SESSION['objLogin']['branch_id'] . "')";
    ...
    $sql_update = "UPDATE `tbl_add_employee_salary_setup` 
    set emp_name = '$_POST[ddlEmpName]',`designation`='" . $_POST['hdnDesg'] . "',`month_id`='" . $month_id . "',`xyear`='" . $year_id . "',`amount`='" . $_POST['txtEmpAmount'] . "',`issue_date`='" . $_POST['txtEmpIssueDate'] . "' 
    where emp_id= '" . (int)$_POST['hdnSpid'] . "'";
            ...
            <div class="form-group col-md-6">
              ...
              <select name="ddlYear" id="ddlYear" class="form-control">
                ...
                while ($row_unit = mysqli_fetch_array($result_unit)) { ?>
                  <option <?php if ($salary_year == $row_unit['y_id']) {
                            echo 'selected';
