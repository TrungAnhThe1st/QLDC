...
<section class="content">
      ...
      <div class="box box-success">
        ...
        <div class="box-body">
          ...
          <table class="table sakotable table-bordered table-striped dt-responsive">
            ...
            <tbody>
              <?php
              $result = mysqli_query($link, "Select *,y.xyear, a.name as area_name from tblbranch b 
              left join tbl_add_year_setup y on b.building_make_year = y.y_id 
              inner join tbl_area a on a.id = b.area_id 
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            ...
                            <div class="row">
                              <div class="col-xs-6">
                                <b><?php echo "Khu"; ?> : </b> <?php echo $row['area_name']; ?><br />
                                <b><?php echo $_data['text_4']; ?> : </b> <?php echo $row['branch_name']; ?><br />
  ...
  <script type="text/javascript">
    function deleteBranch(Id) {
      var iAnswer = confirm("Bạn có chắc muốn xóa tòa nhà này?");
      if (iAnswer) {
