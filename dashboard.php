  ...
  <div class="row home_dash_box">
    ...
    <div class="col-lg-3 col-xs-6">
      <div class="small-box bg-green">
        ...
        <a href="<?php echo WEB_URL; ?>employee/employee_salary_setup.php" class="small-box-footer"><?php echo $_data['dashboard_more_info']; ?> <i class="fa fa-arrow-circle-right"></i></a>
      </div>
    </div>
    <!-- ./col end -->
    <!-- col start -->
    <div class="col-lg-3 col-xs-6">
      <div class="small-box bg-green">
        ...
        <a href="<?php echo WEB_URL; ?>complain/complainlist.php" class="small-box-footer"><?php echo $_data['dashboard_more_info']; ?> <i class="fa fa-arrow-circle-right"></i></a>
      </div>
    </div>
    <!-- ./col end -->
  </div>
                          ...
                          <div class="modal-body">
                            ...
                            <div class="row">
                              <div class="col-xs-6"> <b><?php echo $_data['v_table_column_1']; ?> :</b> <?php echo $row['issue_date']; ?><br />
                                ...
                                <b><?php echo $_data['v_table_column_4']; ?> :</b> <?php echo $row['address']; ?><br />
                              </div>
