    ...
    <div class="box box-success">
      ...
      <div class="box-body">
        <table class="table sakotable table-bordered table-striped dt-responsive">
          <thead>
            <tr>
              <th><?php echo $_data['floor_id'];?></th>
              <th><?php echo $_data['unit_id'];?></th>
              <th><?php echo $_data['action_text'];?></th>
            </tr>
          </thead>
          <tbody>
            <?php
				$result = mysqli_query($link,"Select f.floor_id,u.unit_id,u.uid from tbl_add_unit u inner join tbl_add_floor f on f.fid = u.floor_id where u.branch_id = " . (int)$_SESSION['objLogin']['branch_id'] . " order by u.uid ASC");
