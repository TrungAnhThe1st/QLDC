        ...
        <div class="box box-success">
          ...
          <div class="box-body">
			...
			<table style="font-size:13px;" class="table sakotable table-bordered table-striped dt-responsive">
              ...
              <tbody>
            <?php
				$query = "Select *,f.floor_id as ffloor,u.unit_id from tbl_add_rent r inner join tbl_add_floor f on f.fid = r.r_floor_id inner join tbl_add_unit u on u.uid = r.r_unit_id where r.branch_id = '" . (int)$_SESSION['objLogin']['branch_id'] . "'";
				if($_GET['rsid'] != ''){
