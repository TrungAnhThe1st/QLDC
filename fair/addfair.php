          ...
          <div class="box-body row">
            ...
            <div class="form-group col-md-6">
              ...
              <select name="ddlYear" id="ddlYear" class="form-control">
                ...
                <?php
                $result_year = mysqli_query($link, "SELECT * FROM tbl_add_year_setup order by y_id ASC");
                while ($row = mysqli_fetch_array($result_year)) {
                ?>
                  <option <?php if ($xyear == $row['xyear']) {
                            echo 'selected';
                          } ?> value="<?php echo $row['xyear']; ?>"><?php echo $row['xyear']; ?></option>
                <?php } ?>
              </select>
            </div> -->
            <div class="form-group col-md-6">
