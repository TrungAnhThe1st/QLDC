...
if (isset($_POST['txtCTitle'])) {
	$xmonth = date('n', strtotime(str_replace('/', '-', $_POST['txtCDate'])));
	$xyear = date('Y', strtotime(str_replace('/', '-', $_POST['txtCDate'])));
	if (isset($_POST['hdn']) && $_POST['hdn'] == '0') {
		...
		$sql = "UPDATE `tbl_add_complain` 
		SET c_month=$xmonth,c_year=$xyear,`c_title`='" . $_POST['txtCTitle'] . "',`c_description`='" . $_POST['txtCDescription'] . "',`c_date`='" . $_POST['txtCDate'] . "' 
		WHERE complain_id='" . $_GET['id'] . "'";
		//echo $sql;
		//die();
		mysqli_query($link, $sql);
				...
				<form onSubmit="return validateMe();" action="<?php echo $form_url; ?>" method="post" enctype="multipart/form-data">
					...
					<div class="box-footer">
						<div class="form-group pull-right">
							...
							<a class="btn btn-warning" href="<?php echo WEB_URL; ?>complain/complainlist.php"><i class="fa fa-reply"></i> <?php echo $_data['back_text']; ?></a>
						</div>
					</div>
