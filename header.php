  ...
  <div class="wrapper">
    <header class="main-header">
      ...
      <a class="logo">
        ...
        <span class="logo-mini"><i class="fa fa-bank"></i></span> <span class="logo-lg" style="text-transform:uppercase;font-weight:bold;overflow:hidden;"><i class="fa fa-bank"></i> <?php echo $building_name; ?>
      </a>
                ...
                <li class="user-header"> <img src="<?php echo $image; ?>" class="img-circle" alt="User Image" />
                  <p> <?php echo $_SESSION['objLogin']['name']; ?> <small>
                      <?php if ($_SESSION['login_type'] == '1') {
                        echo $_data['user_admin'];
                      } else if ($_SESSION['login_type'] == '2') {
                        echo $_data['user_owner'];
                      } else if ($_SESSION['login_type'] == '3') {
                        echo $_data['user_employee'];
                      } else if ($_SESSION['login_type'] == '4') {
                        echo $_data['user_tenant'];
                      } else {
    ...
    <aside class="main-sidebar">
      ...
      <div class="user-panel" style="background:#000;">
        ...
        <div class="pull-left info">
          ...
          <a href="#"><i class="fa fa-circle text-success" style="color:#00a65a !important;"></i> <?php echo $_data['lang_online']; ?></a>
        </div>
      </div>
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          <li class="<?php if ($page_name != '' && $page_name == 'dashboard') {
                        echo 'active';
                      } ?>"><a href="<?php echo WEB_URL; ?>dashboard.php"><i class="fa fa-line-chart"></i> <span><?php echo $_data['menu_dashboard']; ?></span></a> </li>
          <li class="treeview <?php if ($page_name != '' && $page_name == 'addfloor' || $page_name == 'floorlist') {
                                echo 'active';
                              } ?>"> <a href="#"> <i class="fa fa-clone"></i> <span><?php echo $_data['menu_floor']; ?></span> <i class="fa fa-angle-left pull-right"></i> </a>
            <ul class="treeview-menu">
              <li class="<?php if ($page_name != '' && $page_name == 'floorlist') {
                            echo 'active';
                          } ?>"><a href="<?php echo WEB_URL; ?>floor/floorlist.php"><i class="fa fa-angle-double-right"></i><?php echo $_data['menu_floor_list']; ?></a></li>
              <li class="<?php if ($page_name != '' && $page_name == 'addfloor') {
                            echo 'active';
                          } ?>"><a href="<?php echo WEB_URL; ?>floor/addfloor.php"><i class="fa fa-angle-double-right"></i><?php echo $_data['menu_floor_add']; ?></a></li>
            </ul>
          </li>
          <li class="treeview <?php if ($page_name != '' && $page_name == 'addunit' || $page_name == 'unitlist') {
                                echo 'active';
                              } ?>"> <a href="#"> <i class="fa fa-cubes"></i> <span><?php echo $_data['menu_unit_information']; ?></span> <i class="fa fa-angle-left pull-right"></i> </a>
            <ul class="treeview-menu">
              <li class="<?php if ($page_name != '' && $page_name == 'unitlist') {
                            echo 'active';
                          } ?>"><a href="<?php echo WEB_URL; ?>unit/unitlist.php"><i class="fa fa-angle-double-right"></i><?php echo $_data['menu_unit_list']; ?></a></li>
              <li class="<?php if ($page_name != '' && $page_name == 'addunit') {
                            echo 'active';
                          } ?>"><a href="<?php echo WEB_URL; ?>unit/addunit.php"><i class="fa fa-angle-double-right"></i><?php echo $_data['menu_add_unit']; ?></a></li>
            </ul>
          </li>
          <!-- <li class="treeview <?php if ($page_name != '' && $page_name == 'addowner' || $page_name == 'ownerlist') {
                                      echo 'active';
                                    } ?>"> <a href="#"> <i class="fa fa-user-o"></i> <span><?php echo $_data['menu_owner_information']; ?></span> <i class="fa fa-angle-left pull-right"></i> </a>
            <ul class="treeview-menu">
              <li class="<?php if ($page_name != '' && $page_name == 'ownerlist') {
                            echo 'active';
                          } ?>"><a href="<?php echo WEB_URL; ?>owner/ownerlist.php"><i class="fa fa-angle-double-right"></i><?php echo $_data['menu_owner_list']; ?></a></li>
              <li class="<?php if ($page_name != '' && $page_name == 'addowner') {
                            echo 'active';
                          } ?>"><a href="<?php echo WEB_URL; ?>owner/addowner.php"><i class="fa fa-angle-double-right"></i><?php echo $_data['menu_add_owner']; ?></a></li>
            </ul>
          </li> -->
          <li class="treeview <?php if ($page_name != '' && $page_name == 'addrent' || $page_name == 'rentlist') {
            ...
            <ul class="treeview-menu">
              <li class="<?php if ($page_name != '' && $page_name == 'rentlist') {
                            echo 'active';
                          } ?>"><a href="<?php echo WEB_URL; ?>rent/rentlist.php"><i class="fa fa-angle-double-right"></i><?php echo $_data['menu_renter_list']; ?></a></li>
              <li class="<?php if ($page_name != '' && $page_name == 'addrent') {
                            echo 'active';
                          } ?>"><a href="<?php echo WEB_URL; ?>rent/addrent.php"><i class="fa fa-angle-double-right"></i><?php echo $_data['menu_add_renter']; ?></a></li>
            </ul>
          </li>
          <li class="treeview <?php if ($page_name != '' && $page_name == 'addemployee' || $page_name == 'employeelist' || $page_name == 'employee_salary_setup' || $page_name == 'leave_request_list') {
                                echo 'active';
                              } ?>"> <a href="#"> <i class="fa fa-user" aria-hidden="true"></i> <span><?php echo $_data['menu_employee_information']; ?></span> <i class="fa fa-angle-left pull-right"></i> </a>
            <ul class="treeview-menu">
              ...
              <li class="<?php if ($page_name != '' && $page_name == 'employee_salary_setup') {
                            echo 'active';
                          } ?>"><a href="<?php echo WEB_URL; ?>employee/employee_salary_setup.php"><i class="fa fa-angle-double-right"></i><?php echo $_data['menu_employee_setup']; ?></a></li>
              <li class="<?php if ($page_name != '' && $page_name == 'leave_request_list') {
                            echo 'active';
                          } ?>"><a href="<?php echo WEB_URL; ?>employee/leave_request_list.php"><i class="fa fa-angle-double-right"></i><?php echo $_data['menu_employee_leave']; ?></a></li>
            </ul>
          </li>
          <li class="treeview <?php if ($page_name != '' && $page_name == 'addfair' || $page_name == 'fairlist') {
            ...
            <ul class="treeview-menu">
              <li class="<?php if ($page_name != '' && $page_name == 'fairlist') {
                            echo 'active';
                          } ?>"><a href="<?php echo WEB_URL; ?>fair/fairlist.php"><i class="fa fa-angle-double-right"></i><?php echo $_data['menu_rent_list']; ?></a></li>
          ...
          <!-- <li class="treeview <?php if ($page_name != '' && $page_name == 'add_owner_utility' || $page_name == 'owner_utility_list') {
            ...
            <ul class="treeview-menu">
              <li class="<?php if ($page_name != '' && $page_name == 'owner_utility_list') {
                            echo 'active';
                          } ?>"><a href="<?php echo WEB_URL; ?>owner_utility/owner_utility_list.php"><i class="fa fa-angle-double-right"></i><?php echo $_data['menu_owner_utility_list']; ?></a></li>
              <li class="<?php if ($page_name != '' && $page_name == 'add_owner_utility') {
                            echo 'active';
                          } ?>"><a href="<?php echo WEB_URL; ?>owner_utility/add_owner_utility.php"><i class="fa fa-angle-double-right"></i><?php echo $_data['menu_add_owner_utility']; ?></a></li>
            </ul>
          </li> -->
          <li class="treeview <?php if ($page_name != '' && $page_name == 'add_maintenance_cost' || $page_name == 'maintenance_cost_list') {
                                echo 'active';
                              } ?>"> <a href="#"> <i class="fa fa-cut"></i> <span><?php echo $_data['menu_maintenance_cost']; ?></span> <i class="fa fa-angle-left pull-right"></i> </a>
            <ul class="treeview-menu">
              <li class="<?php if ($page_name != '' && $page_name == 'maintenance_cost_list') {
                            echo 'active';
                          } ?>"><a href="<?php echo WEB_URL; ?>maintenance/maintenance_cost_list.php"><i class="fa fa-angle-double-right"></i><?php echo $_data['menu_maintenance_cost_list']; ?></a></li>
              <li class="<?php if ($page_name != '' && $page_name == 'add_maintenance_cost') {
                            echo 'active';
                          } ?>"><a href="<?php echo WEB_URL; ?>maintenance/add_maintenance_cost.php"><i class="fa fa-angle-double-right"></i><?php echo $_data['menu_add_maintenance_cost']; ?></a></li>
            </ul>
          </li>
          <!-- <li class="treeview <?php if ($page_name != '' && $page_name == 'add_m_committee' || $page_name == 'm_committee_list') {
            ...
            <ul class="treeview-menu">
              <li class="<?php if ($page_name != '' && $page_name == 'm_committee_list') {
                            echo 'active';
                          } ?>"><a href="<?php echo WEB_URL; ?>management/m_committee_list.php"><i class="fa fa-angle-double-right"></i><?php echo $_data['menu_member_list']; ?></a></li>
              <li class="<?php if ($page_name != '' && $page_name == 'add_m_committee') {
                            echo 'active';
                          } ?>"><a href="<?php echo WEB_URL; ?>management/add_m_committee.php"><i class="fa fa-angle-double-right"></i><?php echo $_data['menu_add_member']; ?></a></li>
            </ul>
          </li> -->
          <!-- <li class="treeview <?php if ($page_name != '' && $page_name == 'add_fund' || $page_name == 'fund_list') {
            ...
            <ul class="treeview-menu">
              <li class="<?php if ($page_name != '' && $page_name == 'fund_list') {
                            echo 'active';
                          } ?>"><a href="<?php echo WEB_URL; ?>fund/fund_list.php"><i class="fa fa-angle-double-right"></i><?php echo $_data['menu_fund_list']; ?></a></li>
              <li class="<?php if ($page_name != '' && $page_name == 'add_fund') {
                            echo 'active';
                          } ?>"><a href="<?php echo WEB_URL; ?>fund/add_fund.php"><i class="fa fa-angle-double-right"></i><?php echo $_data['menu_add_fund']; ?></a></li>
            </ul>
          </li> -->
          <li class="treeview <?php if ($page_name != '' && $page_name == 'add_bill' || $page_name == 'bill_list') {
                                echo 'active';
                              } ?>"> <a href="#"> <i class="fa fa-bank"></i> <span><?php echo $_data['menu_bill']; ?></span> <i class="fa fa-angle-left pull-right"></i> </a>
            <ul class="treeview-menu">
              <li class="<?php if ($page_name != '' && $page_name == 'bill_list') {
                            echo 'active';
                          } ?>"><a href="<?php echo WEB_URL; ?>bill/bill_list.php"><i class="fa fa-angle-double-right"></i><?php echo $_data['menu_bill_list']; ?></a></li>
              <li class="<?php if ($page_name != '' && $page_name == 'add_bill') {
                            echo 'active';
                          } ?>"><a href="<?php echo WEB_URL; ?>bill/add_bill.php"><i class="fa fa-angle-double-right"></i><?php echo $_data['menu_add_bill']; ?></a></li>
            </ul>
          </li>
          <li class="treeview <?php if ($page_name != '' && $page_name == 'addcomplain' || $page_name == 'complainlist') {
                                echo 'active';
                              } ?>"> <a href="#"> <i class="fa fa-comments"></i> <span><?php echo $_data['menu_complain']; ?></span> <i class="fa fa-angle-left pull-right"></i> </a>
            <ul class="treeview-menu">
              <li class="<?php if ($page_name != '' && $page_name == 'complainlist') {
                            echo 'active';
                          } ?>"><a href="<?php echo WEB_URL; ?>complain/complainlist.php"><i class="fa fa-angle-double-right"></i><?php echo $_data['menu_complain_list']; ?></a></li>
              <li class="<?php if ($page_name != '' && $page_name == 'addcomplain') {
                            echo 'active';
                          } ?>"><a href="<?php echo WEB_URL; ?>complain/addcomplain.php"><i class="fa fa-angle-double-right"></i><?php echo $_data['menu_add_complain']; ?></a></li>
            </ul>
          </li>
          <li class="treeview <?php if ($page_name != '' && $page_name == 'addvisitor' || $page_name == 'visitorlist') {
                                echo 'active';
                              } ?>"> <a href="#"> <i class="fa fa-car"></i> <span><?php echo $_data['menu_visitor']; ?></span> <i class="fa fa-angle-left pull-right"></i> </a>
            <ul class="treeview-menu">
              <li class="<?php if ($page_name != '' && $page_name == 'visitorlist') {
                            echo 'active';
                          } ?>"><a href="<?php echo WEB_URL; ?>visitor/visitorlist.php"><i class="fa fa-angle-double-right"></i><?php echo $_data['menu_visitor_list']; ?></a></li>
              <li class="<?php if ($page_name != '' && $page_name == 'addvisitor') {
                            echo 'active';
                          } ?>"><a href="<?php echo WEB_URL; ?>visitor/addvisitor.php"><i class="fa fa-angle-double-right"></i><?php echo $_data['menu_add_visitor']; ?></a></li>
            </ul>
          </li>
          <li class="treeview <?php if ($page_name != '' && $page_name == 'addmeeting' || $page_name == 'meetinglist') {
                                echo 'active';
                              } ?>"> <a href="#"> <i class="fa fa-handshake-o"></i> <span><?php echo $_data['menu_meeting']; ?></span> <i class="fa fa-angle-left pull-right"></i> </a>
            <ul class="treeview-menu">
              <li class="<?php if ($page_name != '' && $page_name == 'meetinglist') {
                            echo 'active';
                          } ?>"><a href="<?php echo WEB_URL; ?>meeting/meetinglist.php"><i class="fa fa-angle-double-right"></i><?php echo $_data['menu_meeting_list']; ?></a></li>
              <li class="<?php if ($page_name != '' && $page_name == 'addmeeting') {
                            echo 'active';
                          } ?>"><a href="<?php echo WEB_URL; ?>meeting/addmeeting.php"><i class="fa fa-angle-double-right"></i><?php echo $_data['menu_add_meeting']; ?></a></li>
            </ul>
          </li>
          <li class="treeview <?php if ($page_name != '' && $page_name == 'notice' || $page_name == 'employee_notice' || $page_name == 'owner_notice') {
                                echo 'active';
                              } ?>"> <a href="#"> <i class="fa fa-bullhorn" aria-hidden="true"></i> <span><?php echo $_data['notice_board']; ?></span> <i class="fa fa-angle-left pull-right"></i> </a>
            <ul class="treeview-menu">
              <li class="<?php if ($page_name != '' && $page_name == 'notice') {
                            echo 'active';
                          } ?>"><a href="<?php echo WEB_URL; ?>notice/notice.php"><i class="fa fa-angle-double-right"></i><?php echo $_data['notice_board_1']; ?></a></li>
              <li class="<?php if ($page_name != '' && $page_name == 'employee_notice') {
                            echo 'active';
          ...
          <li class="treeview <?php if ($page_name != '' && $page_name == 'fair_report' || $page_name == 'rented_report' || $page_name == 'visitors_report' || $page_name == 'complain_report' || $page_name == 'unit_report' || $page_name == 'fund_status' || $page_name == 'bill_report' || $page_name == 'salary_report') {
            ...
            <ul class="treeview-menu">
              <li class="<?php if ($page_name != '' && $page_name == 'fair_report') {
                            echo 'active';
                          } ?>"><a href="<?php echo WEB_URL; ?>report/fair_report.php"><i class="fa fa-angle-double-right"></i><?php echo $_data['menu_fair_report']; ?></a></li>
              <li class="<?php if ($page_name != '' && $page_name == 'rented_report') {
                            echo 'active';
                          } ?>"><a href="<?php echo WEB_URL; ?>report/rented_report.php"><i class="fa fa-angle-double-right"></i><?php echo $_data['menu_rented_report']; ?></a></li>
              <li class="<?php if ($page_name != '' && $page_name == 'visitors_report') {
                            echo 'active';
                          } ?>"><a href="<?php echo WEB_URL; ?>report/visitors_report.php"><i class="fa fa-angle-double-right"></i><?php echo $_data['menu_visitors_report']; ?></a></li>
              <li class="<?php if ($page_name != '' && $page_name == 'complain_report') {
                            echo 'active';
                          } ?>"><a href="<?php echo WEB_URL; ?>report/complain_report.php"><i class="fa fa-angle-double-right"></i><?php echo $_data['menu_complain_report']; ?></a></li>
              ...
              <li class="<?php if ($page_name != '' && $page_name == 'salary_report') {
                            echo 'active';
                          } ?>"><a href="<?php echo WEB_URL; ?>report/salary_report.php"><i class="fa fa-angle-double-right"></i><?php echo $_data['salary_report_text']; ?></a></li>
            </ul>
          </li>
          ...
          <?php if ((int)$_SESSION['login_type'] == 5) { ?>
            <!-- <li class="treeview <?php if ($page_name != '' && $page_name == 'cleardata' || $page_name == 'visitorlist') {
              ...
              <ul class="treeview-menu">
                <li class="<?php if ($page_name != '' && $page_name == 'cleardata') {
                              echo 'active';
            ...
            <li class="treeview <?php if ($page_name != '' && $page_name == 'bill_setup' || $page_name != '' && $page_name == 'utility_bill_setup' || $page_name == 'member_type_setup' || $page_name == 'month_setup' || $page_name == 'year_setup' || $page_name == 'language' || $page_name == 'admin' || $page_name == 'add_building_info' || $page_name == 'branchlist' || $page_name == 'addbranch' || $page_name == 'currency_setup' || $page_name == 'language_setup') {
              ...
              <ul class="treeview-menu">
                ...
                <li class="<?php if ($page_name != '' && $page_name == 'branchlist' || $page_name == 'addbranch') {
                  ...
                  <ul class="treeview-menu">
                    <li class="<?php if ($page_name != '' && $page_name == 'branchlist') {
                                  echo 'active';
                                } ?>"><a href="<?php echo WEB_URL; ?>branch/branchlist.php"><i class="fa fa-angle-double-right"></i><?php echo $_data['branch_list']; ?></a></li>
                ...
                <li class="<?php if ($page_name != '' && $page_name == 'bill_setup') {
                              echo 'active';
                            } ?>"><a href="<?php echo WEB_URL; ?>setting/bill_setup.php"><i class="fa fa-angle-double-right"></i><?php echo $_data['menu_bill_setup']; ?></a></li>
                <li class="<?php if ($page_name != '' && $page_name == 'utility_bill_setup') {
                              echo 'active';
                            } ?>"><a href="<?php echo WEB_URL; ?>setting/utility_bill_setup.php"><i class="fa fa-angle-double-right"></i><?php echo $_data['menu_utility_bill']; ?></a></li>
                ...
                <li class="<?php if ($page_name != '' && $page_name == 'month_setup') {
                              echo 'active';
                            } ?>"><a href="<?php echo WEB_URL; ?>setting/month_setup.php"><i class="fa fa-angle-double-right"></i><?php echo $_data['menu_month_setup']; ?></a></li>
                <li class="<?php if ($page_name != '' && $page_name == 'year_setup') {
                              echo 'active';
                            } ?>"><a href="<?php echo WEB_URL; ?>setting/year_setup.php"><i class="fa fa-angle-double-right"></i><?php echo $_data['menu_year_setup']; ?></a></li>
                <li class="<?php if ($page_name != '' && $page_name == 'currency_setup') {
                              echo 'active';
                            } ?>"><a href="<?php echo WEB_URL; ?>setting/currency_setup.php"><i class="fa fa-angle-double-right"></i><?php echo $_data['menu_currency_setup']; ?></a></li>
                <li class="<?php if ($page_name != '' && $page_name == 'language') {
                              echo 'active';
                            } ?>"><a href="<?php echo WEB_URL; ?>setting/language.php"><i class="fa fa-angle-double-right"></i><?php echo $_data['menu_language_setup']; ?></a></li>
              </ul>
            </li>
          <?php } ?>
        </ul>
