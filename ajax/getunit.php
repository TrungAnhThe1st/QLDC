	...
	if(isset($_SESSION['objLogin'])){
		if(isset($_POST['token']) && $_POST['token'] == 'getunitinfo'){
			...
			if(isset($_POST['floor_id']) && (int)$_POST['floor_id'] > 0 && isset($_POST['unit_id']) && (int)$_POST['unit_id'] > 0){
				$result = mysqli_query($link,"SELECT *, u.rent_pm from tbl_add_rent inner join tbl_add_unit u on u.uid = tbl_add_rent.r_unit_no 
				where r_floor_no = '" . (int)$_POST['floor_id'] . "' and r_unit_no = '" . (int)$_POST['unit_id'] . "' and r_status = 1");
