...
if (isset($_POST['txtName'])) {
	$month = date('n', strtotime(str_replace('/', '-', $_POST['txtIssueDate'])));
	...
	if (isset($_POST['hdn']) && $_POST['hdn'] == '0') {
		...
		$sql = "UPDATE `tbl_visitor` 
		SET xmonth=$month, xyear=$year, `issue_date`='" . $_POST['txtIssueDate'] . "',`name`='" . $_POST['txtName'] . "',`mobile`='" . $_POST['txtMobile'] . "',`address`='" . $_POST['txtAddress'] . "',`floor_id`='" . $_POST['ddlFloorNo'] . "',`unit_id`='" . $_POST['ddlUnitNo'] . "',`intime`='" . $_POST['txtInTime'] . "',`outtime`='" . $_POST['txtOutTime'] . "' WHERE vid='" . $_GET['id'] . "'";
		mysqli_query($link, $sql);
				...
				<form onSubmit="return validateMe();" action="<?php echo $form_url; ?>" method="post" enctype="multipart/form-data">
					...
					<div class="box-footer">
						<div class="form-group pull-right">
							...
							<a class="btn btn-warning" href="<?php echo WEB_URL; ?>visitor/visitorlist.php"><i class="fa fa-reply"></i> <?php echo $_data['back_text']; ?></a>
						</div>
					</div>
