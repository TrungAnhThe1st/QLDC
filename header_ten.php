    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          <li class="<?php if ($page_name != '' && $page_name == 't_dashboard') {
                        echo 'active';
                      } ?>"><a href="<?php echo WEB_URL; ?>t_dashboard.php"> <i class="fa fa-line-chart"></i><span><?php echo $_data['menu_dashboard']; ?></span></a> </li>
          <li class="<?php if ($page_name != '' && $page_name == 'tenant_details') {
                        echo 'active';
                      } ?>"><a href="<?php echo WEB_URL; ?>t_dashboard/tenant_details.php"> <i class="fa fa-file-text-o"></i><span><?php echo $_data['rented_statement']; ?></span></a></li>
          <li class="<?php if ($page_name != '' && $page_name == 'unit_details') {
                        echo 'active';
                      } ?>"><a href="<?php echo WEB_URL; ?>t_dashboard/unit_details.php"> <i class="fa fa-list"></i><span><?php echo $_data['unit_details']; ?></span></a></li>
          <li class="<?php if ($page_name != '' && $page_name == 'complainlist' || $page_name == 'addcomplain') {
                        echo 'active';
                      } ?>"><a href="<?php echo WEB_URL; ?>t_dashboard/complainlist.php"> <i class="fa fa-comments"></i><span><?php echo $_data['renter_complain_details']; ?></span></a></li>
          <li class="<?php if ($page_name != '' && $page_name == 'r_report') {
                        echo 'active';
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="txtProfileContact" name="txtProfileContact" value="<?php echo $_SESSION['objLogin']['r_contact']; ?>">
                </div>
                <div class="form-group">
