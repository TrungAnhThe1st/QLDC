	...
	<div class="row">
		<div class="col-xs-12">
			...
			<div align="right" style="margin-bottom:1%;">
				<!-- <a class="btn btn-success" data-toggle="tooltip" href="<?php echo WEB_URL; ?>complain/addcomplain.php" data-original-title="<?php echo $_data['text_3']; ?>"><i class="fa fa-plus"></i></a> -->
								...
								<tr>
									...
									<td>
										<?php if ($row['job_status'] == '0') {
											echo $_data['t_status_pending'];
										} ?>
										<?php if ($row['job_status'] == '1') {
											echo $_data['t_status_in_progress'];
										} ?>
										<?php if ($row['job_status'] == '2') {
											echo $_data['t_status_on_hold'];
										} ?>
										<?php if ($row['job_status'] == '3') {
											echo $_data['t_status_completed'];
										} ?>
									</td>
													...
													<div class="modal-body">
														...
														<div class="row">
															<div class="col-xs-6"> <b><?php echo $_data['text_7']; ?> :</b> <?php echo $row['c_date']; ?><br />
																...
																<b><?php echo $_data['t_text_2']; ?> :</b> <?php if ($row['job_status'] == '0') {
																												echo $_data['t_status_pending'];
													...
													<div class="modal-body">
														<div>
															...
															<select style="width:100%;" id="ddlStatus_<?php echo $row['complain_id']; ?>" class="form-control" name="ddlStatus_<?php echo $row['complain_id']; ?>">
																<option value="0" <?php if ($row['job_status'] == '0') {
																						echo 'selected';
																					} ?>><?php echo $_data['t_status_pending']; ?></option>
																<option value="1" <?php if ($row['job_status'] == '1') {
																						echo 'selected';
																					} ?>><?php echo $_data['t_status_in_progress']; ?></option>
																<option value="2" <?php if ($row['job_status'] == '2') {
																						echo 'selected';
																					} ?>><?php echo $_data['t_status_on_hold']; ?></option>
																<option value="3" <?php if ($row['job_status'] == '3') {
																						echo 'selected';
																					} ?>><?php echo $_data['t_status_completed']; ?></option>
															</select>
