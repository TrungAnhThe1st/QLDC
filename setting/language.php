...
if (isset($_POST['ddlLanguage'])) {
  ...
  $sql = "INSERT INTO tbl_settings(`lang_code`,`currency`,`currency_seperator`,`currency_position`,`currency_decimal`,`mail_protocol`,`super_admin_image`,`smtp_hostname`,`smtp_username`,`smtp_password`,`smtp_port`,`smtp_secure`,`cat_username`,`cat_password`,`cat_apikey`, bank_type, bank_number, bank_owner) 
  values('$_POST[ddlLanguage]','$_POST[ddlCurrency]','$_POST[ddlCurrencySeparator]','$_POST[ddlCurrencyPosition]','$_POST[ddlCurrencyDecimal]','$_POST[ddlMailOption]','$image_url','$_POST[smtp_hostname]','$_POST[smtp_username]','$_POST[smtp_password]','$_POST[smtp_port]','$_POST[smtp_secure]','$_POST[cat_username]','$_POST[cat_password]','$_POST[cat_apikey]', '$_POST[txtBankType]', '$_POST[txtBankNumber]', '$_POST[txtBankOwner]')";
          ...
          <div class="box-body">
            ...
            <div class="tab-content">
                ...
                <div class="form-group">
                  ...
                  <select name="ddlCurrency" id="ddlCurrency" class="form-control">
                    ...
                    while ($row_currency = mysqli_fetch_array($result_currency)) { ?>
                      <option <?php if ($currency == $row_currency['symbol']) {
                                echo 'selected';
                              } ?> value="<?php echo $row_currency['symbol']; ?>"><?php echo $row_currency['name']; ?>(<?php echo $row_currency['symbol']; ?>)</option>
                    <?php } ?>
                  </select>
                </div>
                <div class="form-group">
                  ...
                  <select name="ddlCurrencySeparator" id="ddlCurrencySeparator" class="form-control">
                    <option value=""><?php echo $_data['text_8']; ?></option>
                    <option <?php if ($currency_seperator == ".") {
                              echo 'selected';
                            } ?> value="."><?php echo $_data['text_9']; ?></option>
                    <option <?php if ($currency_seperator == ",") {
                              echo 'selected';
                            } ?> value=","><?php echo $_data['text_10']; ?></option>
                  </select>
                </div>
                <div class="form-group">
                  ...
                  <select name="ddlCurrencyPosition" id="ddlCurrencyPosition" class="form-control">
                    <option value=""><?php echo $_data['text_8']; ?></option>
                    <option <?php if ($currency_position == "left") {
                              echo 'selected';
                            } ?> value="left"><?php echo $_data['text_11']; ?></option>
                    <option <?php if ($currency_position == "right") {
                              echo 'selected';
                            } ?> value="right"><?php echo $_data['text_12']; ?></option>
                  </select>
                </div>
                <div class="form-group">
                  ...
                  <select name="ddlCurrencyDecimal" id="ddlCurrencyDecimal" class="form-control">
                    <option value=""><?php echo $_data['text_8']; ?></option>
                    <option <?php if ($currency_decimal == "1") {
                              echo 'selected';
                            } ?> value="1">1 (0.0)</option>
                    <option <?php if ($currency_decimal == "2") {
                              echo 'selected';
                            } ?> value="2">2 (0.00)</option>
                    <option <?php if ($currency_decimal == "3") {
                              echo 'selected';
                            } ?> value="3">3 (0.000)</option>
                    <option <?php if ($currency_decimal == "4") {
                              echo 'selected';
                            } ?> value="4">4 (0.0000)</option>
                  </select>
                </div>
                <div class="form-group">
              ...
              <div id="3" class="tab-pane fade">
                ...
                <div class="form-group">
                  ...
                  <select name="ddlMailOption" id="ddlMailOption" class="form-control">
                    <option value=""><?php echo $_data['text_8']; ?></option>
                    <option <?php if ($mail_protocol == "mail") {
                              echo 'selected';
                            } ?> value="mail">Mail</option>
                    <option <?php if ($mail_protocol == "smtp") {
                              echo 'selected';
                ...
                <div class="form-group">
                  ...
                  <select name="smtp_secure" id="smtp_secure" class="form-control">
                    <option value=""><?php echo $_data['text_8']; ?></option>
                    <option <?php if ($smtp_secure == "tls") {
                              echo 'selected';
                            } ?> value="tls">TLS</option>
                    <option <?php if ($smtp_secure == "ssl") {
                              echo 'selected';
              ...
              <div id="5" class="tab-pane fade">
                <p>
                <div class="form-group">
                  <label for="txtBankType"><?php echo "Loại ngân hàng"; ?> :</label>
                  <input type="text" name="txtBankType" id="txtBankType" value="<?php echo $bank_type; ?>" class="form-control" />
                </div>

                <div class="form-group">
                  <label for="txtBankNumber"><?php echo "Số tài khoản"; ?> :</label>
                  <input type="text" name="txtBankNumber" id="txtBankNumber" value="<?php echo $bank_number; ?>" class="form-control" />
                </div>

                <div class="form-group">
                  <label for="txtBankOwner"><?php echo "Chủ tài khoản"; ?> :</label>
                  <input type="text" name="txtBankOwner" id="txtBankOwner" value="<?php echo $bank_owner; ?>" class="form-control" />
                </div>
                </p>
              </div>
